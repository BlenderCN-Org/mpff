...
BAT_D = {   0 : (-0.45, -8.93, -4.89, -7.49, 0.3),    # cas 2
            ...
            2 : (-8.70,  2.29, -8.60, -2.35, 0.8),  # cas 4
            3 : (-8.34,  3.19, -5.55,  6.97, 1),  # cas 1
            4 : (-0.45,  8.94, -4.87,  7.50, 2),    # cas 4
            5 : ( 0.48,  8.92,  4.83,  7.50, 3),
            6 : ( 8.25,  3.26,  5.63,  6.96, 4),
            7 : ( 8.70, -2.35,  8.60,  2.27, 5),  # cas 2
            8 : ( 8.32, -3.18,  5.58, -6.95, 7),  # cas 3
            9 : ( 4.83, -7.50,  0.44, -8.94, 10)   } # cas 3
